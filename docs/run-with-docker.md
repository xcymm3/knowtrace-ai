...
2. 依照 [Supabase 初始化](./supabase-setup.md) 创建项目，并按顺序执行五份 KnowTrace Migration：
   ...
   - `20260811000000_allow_legacy_office_storage_types.sql`
...
5. 对失败任务确认可查看原因并重新提交；对处理中的任务确认可取消。
6. 退出并登录另一个测试账号，确认其无法查看第一个账号的资料。
